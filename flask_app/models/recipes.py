...
class Recipe:
    ...
    def __init__(self, data):
        ...
        #LEFT JOIN
        self.first_name = data['first_name'] #El nombre de la persona que hizo la receta
    ...
    def save(cls, formulario):
        #formulario = {name: "Albondigas", description: "Albondigas de carne", instructions: ".....", date_made:"0000-00-00", under_30: 0, user_id: 1, image}
